(function (main, modules) {
  ...
  'de.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('de.loc/strings/main.lang', {
      ...
      'remove-collection': 'Von der Sammlung entfernen',
      'removed-collection': 'Von der Sammlung entferent',
      'shuffle': 'Shuffle',
      'repeat': 'Wiederholen',
      'start-radio-suggestion': 'Klicke unten, um einen Radiosender basierend auf einem der empfohlenen Titel zu starten.'
    });
  },
  ...
  'es.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('es.loc/strings/main.lang', {
      ...
      'added-collection': 'Se ha a\xF1adido a la colecci\xF3n',
      'remove-collection': 'Retirar de la colecci\xF3n',
      'removed-collection': 'Se ha retirado de la colecci\xF3n',
      'shuffle': 'Aleatorio',
      'repeat': 'Repetir',
      'start-radio-suggestion': 'Haz click para iniciar una emisora de radio con una de estas canciones recomendadas.'
    });
  },
  ...
  'fr.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('fr.loc/strings/main.lang', {
      ...
      'start-radio-suggestion': 'Cliquez ci-dessous pour lancer la radio li\xE9e \xE0 l\'un de ces titres recommand\xE9s.'
    });
  },
  ...
  'id.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('id.loc/strings/main.lang', {
      ...
      'shuffle': 'Acak',
      'repeat': 'Ulangi',
      'start-radio-suggestion': 'Klik di bawah ini untuk memulai stasiun radio dari salah satu rekomendasi lagu ini.'
    });
  },
  'it.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('it.loc/strings/main.lang', {
      ...
      'repeat': 'Ripeti',
      'start-radio-suggestion': 'Clicca sotto per avviare una stazione radio da uno di questi brani consigliati.'
    });
  },
  ...
  'nl.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('nl.loc/strings/main.lang', {
      ...
      'shuffle': 'Shuffle',
      'repeat': 'Herhalen',
      'start-radio-suggestion': 'Klik hieronder om een \u200B\u200Bradiozender te starten met een van deze aanbevolen nummers.'
    });
  },
  'pl.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('pl.loc/strings/main.lang', {
      ...
      'repeat': 'Powtarzaj',
      'start-radio-suggestion': 'Kliknij poni\u017Cej, aby w\u0142\u0105czy\u0107 stacj\u0119 radiow\u0105 na podstawie jednego z tych polecanych utwor\xF3w.'
    });
  },
  'pt-br.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('pt-br.loc/strings/main.lang', {
      ...
      'remove-collection': 'Remover da cole\xE7\xE3o',
      'removed-collection': 'Removido da cole\xE7\xE3o',
      'shuffle': 'Ordem aleat\xF3ria',
      'repeat': 'Repetir',
  ...
  'th.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('th.loc/strings/main.lang', {
      ...
      'next': '\u0E16\u0E31\u0E14\u0E44\u0E1B',
      'back': '\u0E01\u0E25\u0E31\u0E1A',
      'add-collection': '\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E44\u0E1B\u0E22\u0E31\u0E07\u0E04\u0E2D\u0E25\u0E40\u0E25\u0E04\u0E0A\u0E31\u0E19',
      'added-collection': '\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E44\u0E1B\u0E22\u0E31\u0E07\u0E04\u0E2D\u0E25\u0E40\u0E25\u0E04\u0E0A\u0E31\u0E19\u0E41\u0E25\u0E49\u0E27',
  ...
  'tr.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('tr.loc/strings/main.lang', {
      ...
      'remove-collection': 'Koleksiyondan \xE7\u0131kar',
  ...
  'zsm.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('zsm.loc/strings/main.lang', {
      ...
      'shuffle': 'Shuffle',
      'repeat': 'Ulangi',
      'start-radio-suggestion': 'Klik di bawah untuk memulakan stesen radio dari salah satu lagu yang dicadangkan.'
    });
  },
  'zh-hant.loc/strings/main.lang': function (require, module, exports, global, __filename, __dirname) {
    module.exports = new SpotifyApi.LangModule('zh-hant.loc/strings/main.lang', {
      ...
      'removed-collection': '\u5DF2\u5F9E\u6536\u85CF\u4E2D\u79FB\u9664',
      'shuffle': '\u96A8\u6A5F\u64AD\u653E',
      'repeat': '\u91CD\u64AD',
      'start-radio-suggestion': '\u8ACB\u6309\u4E0B\u9762\uFF0C\u900F\u904E\u5176\u4E2D\u4E00\u9996\u63A8\u85A6\u6B4C\u66F2\u5EFA\u7ACB\u96FB\u53F0\u983B\u9053\u3002'
    });
  },
  ...
  'node_modules/api/scripts/library.js': function (require, module, exports, global, __filename, __dirname) {
    (function (models, hermes) {
      ...
      function LibraryTracksCollection(library, owner) {
        ...
        this.owner = owner;
        models.BridgeCollection.call(this, models.Track, owner.uri + ':collection', 'library_tracks');
      ...
      SP.inherit(LibraryTracksCollection, models.BridgeCollection);
      LibraryTracksCollection.prototype.add = function (items) {
        var trackUris = SP.uris(arguments);
        var self = this;
        var promise = new models.Promise();
        this._library._initPromise.done(function () {
          if (self._library._useBridgeForCollection) {
            SP.request('library_tracks_append', [self.descriptor].concat(trackUris), promise, promise.setDone, promise.setFail);
          } else {
            var trackIds = self._library._urisToIds(trackUris);
            hermes.Hermes.request('POST', 'hm://collection-web/v1/' + encodeURIComponent(self.owner.username) + '/tracks', [], []).send(JSON.stringify(trackIds)).done(function (result) {
              promise.setDone();
      ...
      LibraryTracksCollection.prototype.remove = function (ref) {
        var self = this;
        var promise = new models.Promise();
        this._library._initPromise.done(function () {
          if (self._library._useBridgeForCollection) {
            SP.request('library_tracks_remove', [
              self.descriptor,
              ref.index,
              ref.uri
            ], promise, promise.setDone, promise.setFail);
          } else {
            var trackIds = self._library._urisToIds([ref.uri]);
            hermes.Hermes.request('DELETE', 'hm://collection-web/v1/' + encodeURIComponent(self.owner.username) + '/tracks', [], []).send(JSON.stringify(trackIds)).done(function (result) {
              promise.setDone();
              models.client.broadcast('collection-changed');
            }).fail(promise.setFail.bind(promise));
          }
      ...
      LibraryTracksCollection.prototype.contains = function (items) {
        var self = this;
        ...
        this._library._initPromise.done(function () {
          if (self._library._useBridgeForCollection) {
            ...
            SP.request('library_tracks_contains', [self.descriptor].concat(uris), promise, done, promise.setFail);
          } else {
            var trackIds = self._library._urisToIds(uris);
            hermes.Hermes.request('POST', 'hm://collection-web/v1/' + encodeURIComponent(self.owner.username) + '/contains/tracks', [], []).send(JSON.stringify(trackIds)).done(function (result) {
      ...
      LibraryTracksCollection.prototype.clear = function () {
        throw new Error('Not implemented');
      };
      LibraryTracksCollection.prototype.insert = function (ref, items) {
        throw new Error('Not implemented');
      };
      LibraryTracksCollection.prototype.trim = function (ref) {
        throw new Error('Not implemented');
      };
      function LibraryAlbumsCollection(library, owner) {
        ...
        this._library = library;
        this.owner = owner;
        models.BridgeCollection.call(this, models.Album, null, 'library_albums', owner.uri);
        this._observed = function () {
          this._library._initPromise.done(function () {
            if (self._library._useBridgeForCollection) {
      ...
      SP.inherit(LibraryAlbumsCollection, models.BridgeCollection);
      LibraryAlbumsCollection.prototype.add = function (album) {
        var albumUris = SP.uris(arguments);
        var self = this;
        var promise = new models.Promise();
        this._library._initPromise.done(function () {
          if (self._library._useBridgeForCollection) {
            SP.request('library_albums_append', [
              self.descriptor,
              album.uri
            ], promise, promise.setDone, promise.setFail);
          } else {
            var albumIds = self._library._urisToIds(albumUris);
            hermes.Hermes.request('POST', 'hm://collection-web/v1/' + encodeURIComponent(self.owner.username) + '/albums', [], []).send(JSON.stringify(albumIds)).done(function (result) {
              promise.setDone();
              models.client.broadcast('collection-changed');
            }).fail(promise.setFail.bind(promise));
          }
      ...
      LibraryAlbumsCollection.prototype.remove = function (ref) {
        var self = this;
        var promise = new models.Promise();
        this._library._initPromise.done(function () {
          if (self._library._useBridgeForCollection) {
            SP.request('library_albums_remove', [
              self.descriptor,
              ref.index,
              ref.uri
            ], promise, promise.setDone, promise.setFail);
          } else {
            var albumIds = self._library._urisToIds([ref.uri]);
            hermes.Hermes.request('DELETE', 'hm://collection-web/v1/' + encodeURIComponent(self.owner.username) + '/albums', [], []).send(JSON.stringify(albumIds)).done(function (result) {
              promise.setDone();
              models.client.broadcast('collection-changed');
            }).fail(promise.setFail.bind(promise));
          }
      ...
      LibraryAlbumsCollection.prototype.contains = function (items) {
        var self = this;
        var uris = SP.uris(arguments);
        var promise = new models.Promise();
        if (!items || items.length == 0) {
        ...
        this._library._initPromise.done(function () {
          if (self._library._useBridgeForCollection) {
            ...
            SP.request('library_albums_contains', [self.descriptor].concat(uris), promise, done, promise.setFail);
          } else {
            var albumIds = self._library._urisToIds(uris);
            hermes.Hermes.request('POST', 'hm://collection-web/v1/' + encodeURIComponent(self.owner.username) + '/contains/albums', [], []).send(JSON.stringify(albumIds)).done(function (result) {
              var contains = JSON.parse(result[0]);
              if (!Array.isArray(items))
                promise.setDone(contains[0]);
              else
      ...
      LibraryAlbumsCollection.prototype.clear = function () {
        throw new Error('Not implemented');
      };
      LibraryAlbumsCollection.prototype.insert = function (ref, items) {
        throw new Error('Not implemented');
      };
      LibraryAlbumsCollection.prototype.trim = function (ref) {
        throw new Error('Not implemented');
      };
  ...
  'node_modules/spotify-live/node_modules/finally/index.js': function (require, module, exports, global, __filename, __dirname) {
    'use strict';
    var prime = require('node_modules/prime/index.js');
    var kindOf = require('node_modules/mout/lang/kindOf.js');
  ...
  'node_modules/spotify-live/index.js': function (require, module, exports, global, __filename, __dirname) {
    ...
    var flow = require('node_modules/spotify-live/node_modules/finally/index.js');
